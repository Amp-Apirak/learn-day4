...
<template>
  ...
  <header
    class="navbar-default bg-gradient-to-r from-blue-500 via-green-500 to-purple-500 text-skin-base py-3 border-b-4 border-white sticky top-0 z-50"
  >
    ...
    >
      ...
      <div
        :class="
          isOpen
            ? 'fixed sm:relative top-16 shadow sm:shadow-none left-4 right-4 rounded-lg overflow-hidden bg-blue-500 sm:bg-transparent py-2'
